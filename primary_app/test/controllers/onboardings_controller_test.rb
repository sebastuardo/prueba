...
class OnboardingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create onboarding" do
    assert_difference('Onboarding.count') do
      post onboardings_url, params: { onboarding: { datail: @onboarding.datail, description: @onboarding.description, name: @onboarding.name, offers_id: @onboarding.offers_id } }
    end
  ...
  test "should update onboarding" do
    patch onboarding_url(@onboarding), params: { onboarding: { datail: @onboarding.datail, description: @onboarding.description, name: @onboarding.name, offers_id: @onboarding.offers_id } }
