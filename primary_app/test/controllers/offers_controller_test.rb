...
class OffersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create offer" do
    assert_difference('Offer.count') do
      post offers_url, params: { offer: { company_id: @offer.company_id, name: @offer.name } }
    end
  ...
  test "should update offer" do
    patch offer_url(@offer), params: { offer: { company_id: @offer.company_id, name: @offer.name } }
